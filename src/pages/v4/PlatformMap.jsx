...
const CREATOR_STEPS = [
  ...
  { n: 6,  title: 'Manage — submission stage', desc: 'Creator dashboard while names roll in, with live results and the brief recap. Scroll to the bottom to see the stage marked in the contest-journey strip.', seed: () => seedCreatorContest(SUBMIT_ID), url: `/v4/contest/${SUBMIT_ID}?phase=submission` },
  { n: 7,  title: 'Manage — voting stage', desc: 'Same dashboard once submissions close and votes start accumulating. Scroll to the bottom to see the stage marked in the contest-journey strip.', seed: () => seedCreatorContest(VOTE_ID), url: `/v4/contest/${VOTE_ID}?phase=voting` },
  { n: 8,  title: 'Manage — pick the winner stage', desc: 'Creator dashboard at the final stage. Scroll to the bottom — the journey strip shows voting closed, and the Pick the winner button opens the leaderboard to crown a name.', seed: () => seedCreatorContest(VOTE_ID), url: `/v4/contest/${VOTE_ID}?phase=winner` },
