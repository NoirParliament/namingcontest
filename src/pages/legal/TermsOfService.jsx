  ...
  return (
    <LegalPage title="Terms of service" eyebrow="What you agree to" updated="May 28, 2026" decor="cool">
      ...
      <p>
        ...
        selection of any winner, are determined by Creators and
        Participants.
      </p>
      ...
      <p>
        ...
        non-refundable once paid. If you are a consumer
        located in the European Economic Area or the United Kingdom, you
        may have a statutory right to withdraw from a distance contract
        within fourteen (14) days. However, by launching a contest you
        expressly request that we begin performance immediately and
        acknowledge that you will lose that right of withdrawal once the
        contest has launched. Where a mandatory refund right applies
        notwithstanding the foregoing, it will be honored to the extent
        required by law.
      </p>
      ...
      <p>
        ...
        submit your User Content and that it does not infringe the
        rights of any third party or violate any law.
      </p>
      ...
      <p>
        ...
        rights, or otherwise lawful to use in any jurisdiction. You are
      ...
      <p>
        User Content, including names and explanations submitted by
        Participants, is the sole responsibility of the person who
        submitted it. Neither The Cypher Group, LLC nor NamingContest
        is responsible or liable for any User Content, including any
        content that is offensive, infringing, inaccurate, unlawful, or
        otherwise objectionable. We do not pre-screen User Content but
        reserve the right, without obligation, to remove or disable
        access to any User Content at our discretion.
      </p>
      ...
      <p>
        ...
        will The Cypher Group, LLC, its officers, members, employees,
